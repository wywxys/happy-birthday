...
export default function ConversationOverlay({
  ...
  return (
    ...
    >
      ...
      {/* Dialog box: clicking or pressing Enter/Space advances the conversation */}
      <div
        className="w-full bg-gradient-to-t from-slate-800/95 to-slate-700/90 p-6 pb-8 cursor-pointer"
        onClick={next}
        onKeyDown={(e) => {
